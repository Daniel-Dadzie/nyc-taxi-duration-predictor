...
def main():
    ...
    with mlflow.start_run() as run:
        ...
        # Use mlflow.sklearn for XGBRegressor (compatible with both sklearn and XGBoost 2.0.3)
    ...
    if promote:
        ...
        print(
            f"✓ Model v{latest_version} promoted to production (alias: '{PRODUCTION_ALIAS}')"
        )
    else:
